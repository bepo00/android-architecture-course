...
class QuestionsListViewMvcImpl(layoutInflater: LayoutInflater, parent: ViewGroup?) : BaseViewMvc(),QuestionsListAdapter.OnQuestionClickListener, QuestionsListViewMvc {
